import type { TeamAvgRankItem } from '../types'

interface TeamAvgRankListProps {
  items: TeamAvgRankItem[]
}
...
export default function TeamAvgRankList({ items }: TeamAvgRankListProps) {
  return (
    <div className="bg-white rounded-xl overflow-hidden">
      <div className="flex items-center px-4 py-2 text-xs text-gray-500 border-b border-gray-100">
        ...
        <span className="w-24 text-right">场均得分</span>
      </div>
            ...
            <div className="flex-1 flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-xs text-gray-400">
                  {item.playerCount} 名选手 · 总分 {item.totalScore.toLocaleString()}
                </div>
              </div>
            </div>
